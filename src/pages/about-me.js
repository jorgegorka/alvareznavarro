  ...
  <div>
    <header className="site-header outer no-cover">
      <Helmet>
        ...
        <meta
          name="description"
          content="I am the founder of Happy Mood Score a feedback and employee engagement tool with an proactive and unique approach that makes give feedback an easy task."
        />
      ...
      <div className="inner">
        <article className="post-full post page no-image">
          ...
          <section className="post-full-content">
            ...
            <p>
              In 2004 I founded Oficina Inmobiliaria and in 2005 I launched the
              first SaaS application for the real estate market in Spain.
              <br />
              In 2008 the real estate bubble burst and the following crisis hit
            ...
            <p>
              ...
              a SaaS application that companies can use to get feedback and
              increase employee engagement.
              <br />
              It has a proactive approach to get feedback from employees and a
              peer-to-peer recognition tool.
              <br />
              Happy Mood Score is also a metric that helps Human Resources
              departments or team managers to detect how engaged and happy are
              their employees. The application uses feedback, gamification,
              analytics and big data to increase employee engagement and talent
              retention.
            </p>
            <p>
            ...
            <p>
              ...
              directed by Gemma Muñoz and organized by KSchool.
            </p>
            <p>
              I live in{' '}
